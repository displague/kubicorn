...
import (
	...
	"github.com/kubicorn/kubicorn/cloud/linode/linode/resources"
)
...
func NewLinodeInstanceModel(known *cluster.Cluster) cloud.Model {
	return &Model{
		known: known,
	}
}

// ClusterModel maps cluster info to Linode Resources.
